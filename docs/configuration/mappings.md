...
- Right-click on operators or properties in Blender's UI
- Use the "Add Mapping" button in preferences
- Extract from the [Info Panel](../features/info.md) for batch creation from operator/property history
